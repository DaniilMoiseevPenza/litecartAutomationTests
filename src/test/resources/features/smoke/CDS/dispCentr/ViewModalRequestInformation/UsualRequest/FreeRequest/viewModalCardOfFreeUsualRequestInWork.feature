@dispCentr
Feature: smoke test, Просмотр модальной карточки бесплатной обычной заявки в статусе в работе, роль ЦДС
  ...
  Scenario: view Modal Card Of Free Usual Request In Work

@dispCentr
Feature: smoke test, Просмотр модальной карточки бесплатной обычной заявки в статусе отклонена, роль ЦДС
  ...
  Scenario: view Modal Card Of Free Usual Rejected Request

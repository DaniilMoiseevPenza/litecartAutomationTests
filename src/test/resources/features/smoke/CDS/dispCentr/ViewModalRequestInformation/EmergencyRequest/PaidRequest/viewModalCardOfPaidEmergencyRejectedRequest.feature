@dispCentr
Feature: smoke test, Просмотр модальной карточки платной аварийной заявки в статусе отклонена, роль ЦДС
  ...
  Scenario: view Modal Card Of Paid Emergency Rejected Request

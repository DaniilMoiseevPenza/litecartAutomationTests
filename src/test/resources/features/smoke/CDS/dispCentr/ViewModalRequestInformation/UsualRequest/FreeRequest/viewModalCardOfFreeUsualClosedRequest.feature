@dispCentr
Feature: smoke test, Просмотр модальной карточки бесплатной обычной заявки в статусе в закрыта, роль ЦДС
  ...
  Scenario: view Modal Card Of Free Usual Closed Request

@dispCentr
Feature: smoke test, Просмотр модальной карточки бесплатной / платной обычной заявки в статусе новая, роль ЦДС
  ...
  Scenario: view Modal Card Of Free/Paid Usual New Request

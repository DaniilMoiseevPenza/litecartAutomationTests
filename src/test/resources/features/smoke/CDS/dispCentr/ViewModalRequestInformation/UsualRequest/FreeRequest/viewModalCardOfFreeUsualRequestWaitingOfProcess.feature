@dispCentr
Feature: smoke test, Просмотр модальной карточки бесплатной обычной заявки в статусе ожидает обработки, роль ЦДС
  ...
  Scenario: view Modal Card Of Free Usual Request Waiting Of Process

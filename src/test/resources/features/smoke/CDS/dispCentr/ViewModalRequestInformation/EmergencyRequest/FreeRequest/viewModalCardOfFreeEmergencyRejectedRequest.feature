@dispCentr
Feature: smoke test, Просмотр модальной карточки бесплатной аварийной заявки в статусе отклонена, роль ЦДС
  ...
  Scenario: view Modal Card Of Free Emergency Rejected Request

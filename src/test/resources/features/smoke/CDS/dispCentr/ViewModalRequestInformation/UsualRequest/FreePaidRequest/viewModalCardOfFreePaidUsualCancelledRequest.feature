@dispCentr
Feature: smoke test, Просмотр модальной карточки бесплатной / платной обычной заявки в статусе отменена, роль ЦДС
  ...
  Scenario: view Modal Card Of Free/Paid Usual Cancelled Request

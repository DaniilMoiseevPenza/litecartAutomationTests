@dispCentr
Feature: smoke test, Просмотр модальной карточки бесплатной аварийной заявки в статусе в работе, роль ЦДС
  ...
  Scenario: view Modal Card Of Free Emergency Request In Work

@dispCentr
Feature: smoke test, Просмотр модальной карточки платной обычной заявки в статусе в работе, роль ЦДС
  ...
  Scenario: view Modal Card Of Paid Usual Request In Work

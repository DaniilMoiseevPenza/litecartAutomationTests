@dispCentr
Feature: smoke test,Просмотр модальной карточки бесплатной / платной аварийной заявки в статусе новая, роль ЦДС
  ...
  Scenario: view Modal Card Of Free/Paid Emergency New Request

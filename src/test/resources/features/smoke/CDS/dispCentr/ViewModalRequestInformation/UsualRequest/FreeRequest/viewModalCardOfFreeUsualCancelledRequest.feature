@dispCentr
Feature: smoke test, Просмотр модальной карточки бесплатной обычной заявки в статусе отменена, роль ЦДС
  ...
  Scenario: view Modal Card Of Free Usual Cancelled Request

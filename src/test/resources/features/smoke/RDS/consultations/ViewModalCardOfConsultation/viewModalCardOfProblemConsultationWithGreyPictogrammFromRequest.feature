@consultations, @rds
Feature: smoke test, Просмотр карточки решенной консультации из заявки
  ...
  Scenario: view Modal Card Of Problem Consultation With Grey Pictogramm From Request

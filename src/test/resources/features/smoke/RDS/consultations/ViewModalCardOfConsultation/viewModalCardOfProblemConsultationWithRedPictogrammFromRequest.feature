@consultations, @rds
Feature: smoke test, Просмотр карточки нерешенной консультации из заявки
  ...
  Scenario: view Modal Card Of Problem Consultation With Red Pictogramm From Request

@dispCentr
Feature: smoke test, Просмотр модальной карточки бесплатной аварийной заявки в статусе новая, роль РДС
  ...
  Scenario: view Modal Card Of Free Emergency New Request

@dispCentr
Feature: smoke test, Просмотр модальной карточки бесплатной / платной аварийной заявки в статусе в работе, роль РДС
  ...
  Scenario: view Modal Card Of Free/Paid Emergency Request In Work

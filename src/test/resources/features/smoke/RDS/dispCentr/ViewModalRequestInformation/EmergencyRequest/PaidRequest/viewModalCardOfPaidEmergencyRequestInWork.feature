@dispCentr
Feature: smoke test, Просмотр модальной карточки платной аварийной заявки в статусе в работе, роль РДС
  ...
  Scenario: view Modal Card Of Paid Emergency Request In Work

@dispCentr
Feature: smoke test, Просмотр модальной карточки бесплатной аварийной заявки в статусе отменена, роль РДС
  ...
  Scenario: view Modal Card Of Free Emergency Cancelled Request

@dispCentr
Feature: smoke test, Просмотр модальной карточки  платной обычной заявки в статусе отклонена, роль РДС
  ...
  Scenario: view Modal Card Of Paid Usual Rejected Request

@dispCentr
Feature: smoke test, Просмотр модальной карточки платной аварийной заявки в статусе закрыта, роль РДС
  ...
  Scenario: view Modal Card Of Paid Emergency Closed Request

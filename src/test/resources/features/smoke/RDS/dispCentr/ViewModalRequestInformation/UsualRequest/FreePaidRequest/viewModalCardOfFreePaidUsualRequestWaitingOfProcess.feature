@dispCentr
Feature: smoke test, Просмотр модальной карточки бесплатной / платной обычной заявки в статусе ожидает обработки, роль РДС
  ...
  Scenario: view Modal Card Of Free/Paid Usual Request Waiting Of Process

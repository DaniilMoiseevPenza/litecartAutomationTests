@dispCentr
Feature: smoke test, Просмотр модальной карточки бесплатной / платной аварийной заявки в статусе отменена, роль РДС
  ...
  Scenario: view Modal Card Of Free/Paid Emergency Cancelled Request

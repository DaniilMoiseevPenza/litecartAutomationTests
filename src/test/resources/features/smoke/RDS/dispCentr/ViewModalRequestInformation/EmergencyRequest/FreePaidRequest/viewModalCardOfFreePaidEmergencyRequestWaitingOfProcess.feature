@dispCentr
Feature: smoke test, Просмотр модальной карточки бесплатной / платной аварийной заявки в статусе ожидает обработки, роль РДС
  ...
  Scenario: view Modal Card Of Free/Paid Emergency Request Waiting Of Process

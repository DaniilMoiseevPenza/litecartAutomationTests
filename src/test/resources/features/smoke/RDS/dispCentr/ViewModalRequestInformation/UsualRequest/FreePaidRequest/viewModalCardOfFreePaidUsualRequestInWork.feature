@dispCentr
Feature: smoke test, Просмотр модальной карточки бесплатной / платной обычной заявки в статусе в работе, роль РДС
  ...
  Scenario: view Modal Card Of Free/Paid Usual Request In Work

@dispCentr
Feature: smoke test, Просмотр модальной карточки платной обычной заявки в статусе ожидает обработки, роль РДС
  ...
  Scenario: view Modal Card Of Paid Usual Request Waiting Of Process

@dispCentr
Feature: smoke test, Отображение отключений на форме создания заявки, роль РДС (при удалении подъезда и квартиры)
  ...
  Scenario: check off on form new request when delete entrance and flat

@dispCentr
Feature: smoke test, Просмотр бесплатной аварийной заявки в статусе ожидает обработки, роль РДС
  ...
  Scenario: view Of Free Emergency Request Waiting Of Process

@dispCentr
Feature: smoke test, Просмотр бесплатной / платной обычной заявки в статусе ожидает обработки, роль РДС
  ...
  Scenario: view Of Free/Paid Usual Request Waiting Of Process

@dispCentr
Feature: smoke test, Просмотр модальной карточки бесплатной аварийной заявки в статусе ожидает обработки, роль ОДС
  ...
  Scenario: view Modal Card Of Free Emergency Request Waiting Of Process

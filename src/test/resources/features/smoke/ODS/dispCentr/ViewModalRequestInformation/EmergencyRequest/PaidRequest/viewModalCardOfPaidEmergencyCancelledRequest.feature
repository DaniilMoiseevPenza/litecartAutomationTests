@dispCentr
Feature: smoke test, Просмотр модальной карточки платной аварийной заявки в статусе отменена, роль ОДС
  ...
  Scenario: view Modal Card Of Paid Emergency Cancelled Request

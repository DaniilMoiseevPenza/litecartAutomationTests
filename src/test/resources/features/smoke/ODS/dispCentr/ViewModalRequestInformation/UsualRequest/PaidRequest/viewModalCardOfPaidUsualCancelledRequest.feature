@dispCentr
Feature: smoke test, Просмотр модальной карточки платной обычной заявки в статусе отменена, роль ОДС
  ...
  Scenario: view Modal Card Of Paid Usual Cancelled Request

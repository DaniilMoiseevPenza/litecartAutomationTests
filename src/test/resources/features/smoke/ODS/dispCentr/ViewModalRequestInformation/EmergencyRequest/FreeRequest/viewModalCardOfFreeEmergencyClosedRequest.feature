@dispCentr
Feature: smoke test, Просмотр модальной карточки бесплатной аварийной заявки в статусе закрыта, роль ОДС
  ...
  Scenario: view Modal Card Of Free Emergency Closed Request

@dispCentr
Feature: smoke test, Отображение отключений на форме создания заявки, роль ОДС (при удалении квартиры)
  ...
  Scenario: check off on form new request when delete flat

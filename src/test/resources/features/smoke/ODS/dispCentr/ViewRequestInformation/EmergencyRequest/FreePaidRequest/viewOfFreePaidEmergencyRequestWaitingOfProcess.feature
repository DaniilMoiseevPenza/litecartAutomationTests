@dispCentr
Feature: smoke test, Просмотр бесплатной / платной аварийной заявки в статусе ожидает обработки, роль ОДС
  ...
  Scenario: view Of Free/Paid Emergency Request Waiting Of Process
